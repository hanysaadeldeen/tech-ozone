<template>
    <main class="contactPage   max-xl:px-6">
        <GredientHero title="تواصل معنا بكل سهولة"
            description="نحن في Techozone جاهزون للرد على استفساراتك وتقديم الدعم لاحتياجاتك. تواصل معنا عبر النموذج أو وسائل الاتصال المتاحة، وسنكون سعداء بخدمتك." />
        ...
        <div class="w-full max-w-[1208px] mx-auto mt-[60px]  md:mt-[120px]">
                    ...
                    <Form @submit="onSubmit" :validation-schema="schema" v-slot="{ errors }"
                        ...
                        <div class="flex flex-col w-full  mb-8 ">
                            ...
                            <Field id="subject" name="subject" as="select"
                                ...
                                <option value="" disabled selected class="text-paragraph-mediumDark">
                                    {{
                                        locale === "en"
                                            ? "Select Request Type"
                                            : "اختر الموضوع"
                ...
                <div class="socailMedia w-full mx-auto max-w-[560px]">
                    <div class="flex flex-col gap-4 md:gap-6">
                        <div v-for="feature in Features"
                            ...
                            <div class="bg-Secondary rounded-2xl p-2 md:p-3 flex justify-center items-center">
                                <img :src="feature.icon" :alt="feature.title" class="w-6 h-6" width="24" height="24">
                            </div>
                            <div>
                                <h3 class="text-xs md:text-sm font-normal text-Text mb-2">{{ feature.title }}</h3>
                                <a :dir="locale === 'ar' ? 'ltr' : ''" :href="feature.link" target="_blank">
                                    <p class="text-TextD3 font-normal text-xs md:text-sm md:!leading-[24px]">{{
                                        feature.description }}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="gradientBg py-6 px-4 lg:py-10 lg:px-8 rounded-xl  mt-6 md:mt-8 md:max-h-fit">
                        <h3 class="text-lg lg:text-xl font-medium text-white mb-4 lg:mb-6 max-md:text-center">

                            هل لديك مشروع وتبحث عن حلول تعقيم مبتكرة؟

                        </h3>
                        <p class="text-TextL font-normal text-xs md:text-base max-md:text-center">

                            اطلب عرض السعر الآن من Techozone لمناقشة احتياجاتك، واحصل على الحل الأمثل بتقنيات الأوزون
                            المتطورة في أسرع وقت.
                        </p>
                        <div
            ...
            <section>
                <section-title btnText="موقعنا الاستراتيجي على الخريطة"
                ...
                <div class="relative w-full max-w-[708px] mx-auto">
                    <div
                        ...
                        <div
                            ...
                            <h1 class="text-TextD2 text-base font-medium mb-1 md:mb-3 text-center">
                                الشركة السعودية للأوزون
                            </h1>
                            <p class="text-TextD3 text-sm font-normal text-center max-w-[400px] mx-auto mb-4 md:mb-8">
                                الرياض، المملكة العربية السعودية
                            </p>
                            <a href="https://www.google.com/maps/search/+ajaj+%D8%AC%D8%AF%D8%A9+-+%D8%AD%D9%8A+%D8%A7%D9%84%D8%B4%D8%A7%D8%B7%D8%A6-+%D9%85%D8%AC%D9%85%D8%B9+%D8%A7%D9%84%D9%85%D9%82%D8%B1+%D8%A7%D9%84%D8%B1%D8%A6%D9%8A%D8%B3%D9%8A+%D9%84%D9%84%D8%A3%D8%B9%D9%85%D8%A7%D9%84%E2%80%AD/@21.5679405,39.1435889,255m/data=!3m1!1e3?entry=ttu&g_ep=EgoyMDI1MDkwMy4wIKXMDSoASAFQAw%3D%3D"
                                target="_blank">
                        ...
                        <div class="mt-9 text-center">
                            <img src="~/assets/img/Utils/locationPin.svg" alt="locationPin" loading="lazy"
                                class="w-fit mx-auto">
                        </div>
                    </div>
                    <div class="w-full max-w-full max-sm:invisible">
                        <img src="~/assets/img/Utils/SaudiMap.svg" alt="SaudiMap" loading="lazy"
            ...
            <section class="max-w-[792px] mx-auto">
                ...
                <section-title btnText="الأسئلة الشائعة" description="إجابات واضحة على أكثر استفساراتكم" />
                <div class="mb-20 relative">

                    <FAQ v-for="(faq, index) in FAQs" :id="faq.id" :question="faq.question" :answer="faq.answer"
                        :toggle="faq.toggle" />
                </div>
...
const faqs = {
    "questionOne": {
        "title": "كم يستغرق الرد على الرسائل؟",
        "answer": "نرد عادة خلال 24 ساعة عمل على الرسائل والاستفسارات."
    },
    "questionTwo": {
        "title": "هل يمكنني التواصل دون فكرة واضحة؟",
        "answer": "نعم، نحن هنا لمساعدتك من أول خطوة — حتى لو كانت فكرتك غير مكتملة."
    },
    "questionThree": {
        "title": "هل تعملون مع جهات خارج السعودية؟",
        "answer": "نحن شركة سعودية، ولكن نخدم عملاء محليين ودوليين عن بُعد بكفاءة واحترافية."
    },
    "questionFour": {
        "title": "ما تكلفة تصميم   في السعودية؟",
        "answer": "تختلف حسب المشروع. يمكنك طلب عرض سعر عبر نموذج التواصل."
    },
    "questionSix": {
        "title": "ما الفرق بين البرمجة المخصصة والتصميم الجاهز؟",
        "answer": "البرمجة المخصصة توفر مرونة أكبر. تصفح أعمالنا لتفهم الفرق."
    },
    "questionSeven": {
        "title": "هل يمكن تنفيذ المشروع بالكامل عن بُعد؟",
        "answer": "بالتأكيد، ونعمل بكفاءة عالية. تعرف علينا من خلال صفحة عن الشركة."
    },
}
...
const FAQs = [
    {
        id: 1,
        question: faqs.questionOne.title,
        answer: faqs.questionOne.answer,
        toggle: true,
    },
    {
        id: 2,
        question: faqs.questionTwo.title,
        answer: faqs.questionTwo.answer,
        toggle: true,
    },
    {
        id: 3,
        question: faqs.questionThree.title,

        answer: faqs.questionThree.answer,
        toggle: false,
    },
    {
        id: 4,
        question: faqs.questionFour.title,

        answer: faqs.questionFour.answer,
        toggle: false,
    }]
