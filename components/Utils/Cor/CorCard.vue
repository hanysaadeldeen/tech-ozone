<template>
    <div
        ...
        <div>
            <h1 class="text-TextD text-xl md:text-2xl font-medium text-center mb-1 md:mb-2">{{ title }}</h1>
            <p class="text-base md:text-lg font-normal text-TextMD text-center">{{ description }}</p>
        </div>
    </div>
</template>
