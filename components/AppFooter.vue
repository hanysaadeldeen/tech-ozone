  ...
  <footer class="relative bg-BG w-full pt-14 pb-10 md:pt-20">
    ...
    >
      <div class="flex-grow">
        ...
        >
          <img
            src="~/assets/img/Utils/LogoH.svg"
        ...
        <nav>
          <ul>
            <li :class="{ active: adjustedPath === '/faqs' }">
              <nuxt-link :to="localePath('/faqs')"> الأسئلة الشائعة </nuxt-link>
            </li>
        ...
        <nav>
          <ul>
            ...
            <li class="pb-0 flex items-center gap-4 group border-none">
              ...
              >
                <i
                  class="fa-solid fa-location-dot text-TextM group-hover:text-Secondary transition-all ease-in-out duration-300"
                ></i>
                <span>
